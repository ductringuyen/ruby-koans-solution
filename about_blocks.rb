...
class AboutBlocks < Neo::Koan
  ...
  def method_split
    yield("This line should be splitted")
  end
  ...
  def test_blocks_can_be_assigned_to_variables_and_called_explicitly
    ...
    assert_equal 14, add_two.call(12)

    # Alternative calling syntax
    assert_equal 11, add_one[10]
    assert_equal 14, add_two[12]
  end

  def test_stand_alone_blocks_can_be_passed_to_methods_expecting_blocks
    make_upper = lambda { |n| n.upcase }
    result0 = method_with_block_arguments(&make_upper)

    make_split = lambda { |x| x.split}
    result1 = method_split(&make_split)
    assert_equal "JIM", result0
    assert_equal ["This", "line", "should", "be", "splitted"], result1
  end
