...
class AboutClassMethods < Neo::Koan
  ...
  def test_classes_are_objects_too    #Class is a object too!
  ...
  def test_you_can_define_methods_on_individual_objects   #you can define methods on individual objects
    fido = Dog.new
    def fido.wag          # these methods are called "singleton"
      :fidos_wag
    end
